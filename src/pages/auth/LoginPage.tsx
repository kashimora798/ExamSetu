  ...
  return (
    <div className="auth-page" id="login-page">
      <div className="auth-card card-elevated">
        ...
        <p className="auth-subtitle">Login to continue your UPTET preparation</p>
        ...
        {sent ? (
          ...
          <>
            <button className="btn auth-google-btn" id="google-login-btn" onClick={() => {
              ...
              <span lang="hi">Google से Login करें</span>
            </button>
            ...
            <form className="auth-form" onSubmit={handleMagicLink}>
              ...
              <button type="submit" className="btn btn-primary" style={{ width: '100%' }} disabled={loading}>
                <span lang="hi">{loading ? 'भेज रहे हैं...' : 'Magic Link भेजें'}</span>
              </button>
            </form>
          </>
        )}
