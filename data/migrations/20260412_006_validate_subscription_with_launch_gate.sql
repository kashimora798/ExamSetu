-- =============================================================================
-- Migration: Recreate validate_subscription with launch gate dependency
-- Date: 2026-04-12
-- Purpose: Ensure subscription RPC works after launch gate migration exists
-- Depends on: 20260412_005_launch_cohort_free_access.sql
-- =============================================================================
...
COMMENT ON FUNCTION validate_subscription IS
  'Validates user subscription and launch-cohort access for gated session types.';
